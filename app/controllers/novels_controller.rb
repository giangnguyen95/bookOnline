class NovelsController < ApplicationController
  ...
  def index
    #@novels = Novel.all
     ...
     @novels = @q.result(distinct: true).page(params[:page])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @novel.save
        ...
        format.json { render action: 'show', status: :created, location: @novel }
      else
  ...
  private
    ...
    def novel_params
      params.require(:novel).permit(:title, :author, :description)
    end
end
